...
I've made small improvement on decoupling the ViewModel and the Store which in my point of view is better because I still want to be able to use the LiveData since they are bound to the lifecycle.
